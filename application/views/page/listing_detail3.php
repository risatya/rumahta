						...
						<fieldset>
							...
							<div id="detail_wrapper">
								<div style="width:100%;float:left;margin-right:20px;">
									<img src="<?php echo base_url(); ?>file/img/icon_listrik.png" width="20px" style="margin-top:-5px;"/> <span>DAYA LISTRIK : </span> <?php echo $item->daya_listrik; ?> M<sup>2</sup><br/>
									<img src="<?php echo base_url(); ?>file/img/icon_luas.png" width="20px" style="margin-top:-5px;"/> <span>LUAS BANGUNAN : </span> <?php echo $item->luas_bangunan; ?> Watt<br/>
								</div>
							</div>
