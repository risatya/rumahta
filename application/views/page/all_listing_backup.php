				...
				<div id="listing_premium_wrapper">
					...
					<div id="listing_premium_list">
						...
						<div id="premium_detail">
							<b><?php echo ucfirst(strtolower($item->nama_kabupaten)); ?> | <?php echo ($item->harga != null ? "Rp. ".$item->harga : "Rp. -"); ?></b><br/>
			...
			<?php } ?>
				...
				<div id="listing_free_wrapper">
					...
					<?php }?>
					<?php //echo anchor("page/all","<p class='seemore'><img src='".base_url."file/img/arrow_left.png'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LIHAT LISTING LAINNYA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='".base_url."file/img/arrow_right.png'/></p>",array("id"=>"seemore")); ?>