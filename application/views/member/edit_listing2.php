					...
					<div id="inside_main_wrapper">
						...
						<?php echo form_open("member_listing/do_edit2/".$item->id_listing_member,array("class"=>"form-horizontal","name"=>"form")); ?>
							...
							<?php foreach($paket_listing as $row): ?>
								...
								<div id="photo_wrapper">
									...
									if($dumb == $cover->id_listing_photo){
										echo anchor("#cover_info","<img src=".base_url()."file/img/cover_badge.png />",array("class"=>"photobtn3","data-toggle"=>"modal","title"=>"Foto ini adalah cover foto listing anda.klik untuk penjelasan lebih detail."));
									}
									else{
