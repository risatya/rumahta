					...
					<div id="inside_main_wrapper">
						...
						<fieldset>
							<legend style="float:left;width:670px;">
								...
								<?php echo anchor("member_listing/edit/".$item->id_listing_member,"Edit Listing")?>
								<?php echo anchor("member_listing/delete/".$item->id_listing_member,"Hapus Listing")?>
							</legend>
							...
							<div id="detail_wrapper">
								<div style="width:100%;float:left;margin-right:20px;">
									<img src="<?php echo base_url(); ?>file/img/icon_listrik.png" width="20px" style="margin-top:-5px;"/> <span>DAYA LISTRIK : </span> <?php echo $item->daya_listrik; ?> <br/>
									<img src="<?php echo base_url(); ?>file/img/icon_luas.png" width="20px" style="margin-top:-5px;"/> <span>LUAS BANGUNAN : </span> <?php echo $item->luas_bangunan; ?> <br/>
								</div>
							</div>
							...
							<div id="detail_wrapper">
								<?php foreach($fasilitas_kios as $row):?>
									<div style="width:33.333%;float:left">
										<?php echo ($row->ac == 1 ? "<img src='".base_url()."file/img/icon_yes.png'/>" : "<img src='".base_url()."file/img/icon_no.png'/>") ?> AC <br/>
										<?php echo ($row->lift == 1 ? "<img src='".base_url()."file/img/icon_yes.png'/>" : "<img src='".base_url()."file/img/icon_no.png'/>") ?> Lift <br/>
									</div>
									<div style="width:33.333%;float:left">
										<?php echo ($row->parkir == 1 ? "<img src='".base_url()."file/img/icon_yes.png'/>" : "<img src='".base_url()."file/img/icon_no.png'/>") ?> Parkir <br/>
									</div>
									<div style="width:33.333%;float:left">
										<?php echo ($row->kantin == 1 ? "<img src='".base_url()."file/img/icon_yes.png'/>" : "<img src='".base_url()."file/img/icon_no.png'/>") ?> Kantin <br/>
									</div>
								<?php endforeach; ?>
							</div>
