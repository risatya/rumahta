					...
					<div id="inside_main_wrapper">
						...
						<?php echo form_open("member_listing/do_edit1/".$item->id_listing_member,array("class"=>"form-horizontal","name"=>"form")); ?>
						...
						<fieldset>
							...
							<div class="control-group" id="alamat">
								...
								<div class="controls docs-input-sizes">
									<textarea rows="3" class="field span4" name="alamat"  style="resize:none;" readonly="yes"><?php echo $item->alamat;?></textarea>*<i><?php echo form_error('alamat'); ?></i>
								</div>
							</div>
							...
							<div style="width:50%;float:left">
								<div class="control-group" id="jlantai">
								 ...
								 <div class="control-group" id="garage">
									...
									<div class="controls">
									  <div class="input-prepend">
										<span class="add-on"><img width="25px;" src="<?php echo base_url(); ?>file/img/icon_garage.png"/></span><input class="span1" id="prependedInput" name="garage"  size="3" type="text" value="<?php echo $item->garasi; ?>" />
									  </div>
								 ...
								 <div class="control-group" id="pembantu">
									...
									<div class="controls">
									  <div class="input-prepend">
										<span class="add-on"><img width="25px;" src="<?php echo base_url(); ?>file/img/icon_pembantu.png"/></span><input class="span1" id="prependedInput" name="pembantu"  size="3" type="text" value="<?php echo $item->pembantu; ?>" />
									  </div>
								 ...
								 <div class="control-group" id="sumberair">
									...
									<div class="controls">
									  <div class="input-prepend">
										<span class="add-on"><img width="25px;" src="<?php echo base_url(); ?>file/img/icon_water.png"/></span><input class="span1" id="prependedInput" name="sumberair"  size="3" type="text" value="<?php echo $item->sumber_air; ?>" />
									  </div>
								 ...
								 <div class="control-group" id="ltanah">
									...
									<div class="controls">
									  <div class="input-prepend input-append">
										<span class="add-on"><img width="25px;" src="<?php echo base_url(); ?>file/img/icon_garden.png"/></span><input class="span1" id="appendPrependedInput" name="ltanah" size="3" type="text" value="<?php echo $item->luas_tanah; ?>" /><span class="add-on">M<sup>2</sup></span>
									  </div>
									...
									<div class="controls">
									  <div class="input-prepend">
										...
										<select name="arah" id="prependedInput" class="span1">
											<option value="" <?php echo($item->mata_angin == null ? "selected" : ""); ?>>-</option>
											<option value="Utara" <?php echo(strtolower($item->mata_angin) == "utara" ? "selected" : ""); ?>>Utara</option>
											<option value="Selatan" <?php echo(strtolower($item->mata_angin) == "selatan" ? "selected" : ""); ?>>Selatan</option>
											<option value="Barat" <?php echo(strtolower($item->mata_angin) == "barat" ? "selected" : ""); ?>>Barat</option>
											<option value="Timur" <?php echo(strtolower($item->mata_angin) == "timur" ? "selected" : ""); ?>>Timur</option>
											<option value="Tenggara" <?php echo(strtolower($item->mata_angin) == "tenggara" ? "selected" : ""); ?>>Tenggara</option>
											<option value="Barat Daya" <?php echo(strtolower($item->mata_angin) == "barat daya" ? "selected" : ""); ?>>Barat Daya</option>
											<option value="Barat Laut" <?php echo(strtolower($item->mata_angin) == "barat laut" ? "selected" : ""); ?>>Barat Laut</option>
											<option value="Timur Laut" <?php echo(strtolower($item->mata_angin) == "timur laut" ? "selected" : ""); ?>>Timur Laut</option>
										</select>
									  </div>
							...
							<div style="width:50%;float:left">
								<div class="control-group" id="ktidur">
									...
									<div class="controls">
									  <div class="input-prepend">
										<span class="add-on"><img width="25px;" src="<?php echo base_url(); ?>file/img/icon_bedroom.png"/></span><input class="span1" id="prependedInput" name="ktidur" size="3" type="text" value="<?php echo $item->jml_ktidur; ?>" />
									  </div>
								 ...
								 <div class="control-group" id="kmandi">
									...
									<div class="controls">
									  <div class="input-prepend">
										<span class="add-on"><img width="25px;" src="<?php echo base_url(); ?>file/img/icon_bathroom.png"/></span><input class="span1" id="prependedInput" name="kmandi" size="3" type="text" value="<?php echo $item->jml_kmandi; ?>" />*<i><?php echo form_error('kmandi'); ?></i>
									  </div>
								 ...
								 <div class="control-group" id="dlistrik">
									...
									<div class="controls">
									  <div class="input-prepend input-append">
										<span class="add-on"><img width="25px;" src="<?php echo base_url(); ?>file/img/icon_listrik.png"/></span><input class="span1" id="appendPrependedInput" name="dlistrik" size="3" type="text" value="<?php echo $item->daya_listrik; ?>" /><span class="add-on">Watt</span>
									  </div>
									...
									<div class="controls">
									  <div class="input-prepend">
										...
										<select name="furniture" size="1" style="width:120px;height:30px;">
											<option value="1" <?php if($item->furniture == "furnished"){echo "selected";}?>>furnished</option>
											<option value="2" <?php if($item->furniture == "semi furnished"){echo "selected";}?>>semi furnished</option>
											<option value="3" <?php if($item->furniture == "unfurnished"){echo "selected";}?>>unfurnished</option>
										</select>
									  </div>
								 ...
								 <div class="control-group" id="lbangunan">
									...
									<div class="controls">
									  <div class="input-prepend input-append">
										<span class="add-on"><img width="25px" src="<?php echo base_url(); ?>file/img/icon_luas.png"/></span><input class="span1" id="appendPrependedInput" name="lbangunan" size="3" type="text" value="<?php echo $item->luas_bangunan; ?>" /><span class="add-on">M<sup>2</sup></span>
									  </div>
					...
					<div id="add_photo" class="modal hide fade" style="display:none;">
						...
						<?php }else{ ?>
						<div class="modal-body">
								Maaf, anda hanya dapat mengupload maksimal <?php echo $batas; ?> gambar.<br/>
						</div>
						<div class="modal-footer">
							<button class="btn btn-primary" data-dismiss="modal" aria-hidden="true">Ok</button>
						</div>
