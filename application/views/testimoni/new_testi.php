					...
					<div id="inside_main_wrapper">
						...
						<fieldset>
							...
							<?php echo form_open("testimoni/submit_testimoni",array("class"=>"form-horizontal","name"=>"form")); ?>
								<textarea id="redactor" name="content" size="10" maxlength="50"></textarea>
								...
								<button type="submit" class="btn btn-large btn-primary">Buat Testimoni</button>
							<?php echo form_close(); ?>
						</fieldset>
					</div>
