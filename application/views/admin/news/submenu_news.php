					...
					<div id="cpanel_wrapper">
						...
						<ul class="nav nav-tabs" style="float:left;width:100%;margin: 20px 0 0 0;">
							...
							<?php echo $active == "all_news" ? "<li class='active'>" : "<li>"; ?>
							<?php echo anchor("news_manager/index","Daftar Berita")."</li>";?>
							
							<?php echo $active == "new_news" ? "<li class='active'>" : "<li>"; ?>
							<?php echo anchor("news_manager/konfirmasi","Konfirmasi Pembayaran Banner")."</li>";?>
