					...
					<div id="cpanel_wrapper">
						...
						<?php echo form_open("member_manager/do_edit_listing3/".$item->id_listing_member."/".$id_user,array("class"=>"form-horizontal","name"=>"form")); ?>
						...
						<fieldset>
							...
							<div id="detail_wrapper">
								<?php foreach($fasilitas_kios as $row):?>
									<div style="width:33.333%;float:left">
										<label class="checkbox">
											<input type="checkbox" name="ac" id="ac" value="1" <?php if($row->ac == 1){echo "checked";} ?> /> AC
										</label>
										<label class="checkbox">
											<input type="checkbox" name="lift" id="lift" value="1" <?php if($row->lift == 1){echo "checked";} ?> /> Lift
										</label>
									</div>
									<div style="width:33.333%;float:left">
										<label class="checkbox">
											<input type="checkbox" name="parkir" id="parkir" value="1" <?php if($row->parkir == 1){echo "checked";} ?> /> Parkir
										</label>
									</div>
									<div style="width:33.333%;float:left">
										<label class="checkbox">
											<input type="checkbox" name="kantin" id="kantin" value="1" <?php if($row->kantin == 1){echo "checked";} ?> /> Kantin
										</label>
									</div>
								<?php endforeach; ?>
							</div>
