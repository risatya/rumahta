					...
					<div id="cpanel_wrapper">
						...
						<?php echo form_open("member_manager/do_edit_listing6/".$item->id_listing_member."/".$id_user,array("class"=>"form-horizontal","name"=>"form")); ?>
							...
							<div class="control-group" id="penghuni">
								...
								<div class="controls docs-input-sizes">
									<select name="penghuni"  size="1" class="span3">
										...
										<option value="1" <?php if($item->penghuni == "pria"){echo "selected";}?>>Pria</option>
										<option value="2" <?php if($item->penghuni == "wanita"){echo "selected";}?>>Wanita</option>
										<option value="3" <?php if($item->penghuni == "karyawan"){echo "selected";}?>>Karyawan</option>
										<option value="4" <?php if($item->penghuni == "karyawati"){echo "selected";}?>>Karyawati</option>
										<option value="5" <?php if($item->penghuni == "Pria dan wanita"){echo "selected";}?>>Pria dan Wanita</option>
										<option value="6" <?php if($item->penghuni == "suami istri / keluarga"){echo "selected";}?>>Suami istri/keluarga</option>
							...
							<div class="control-group" id="penghuni_mayoritas">
								...
								<div class="controls docs-input-sizes">
									<select name="penghuni_mayoritas"  size="1" class="span3">
										...
										<option value="1" <?php if($item->penghuni_mayoritas == "Pelajar/mahasiswa"){echo "selected";}?>>Mahasiswa/pelajar</option>
										<option value="2" <?php if($item->penghuni_mayoritas == "keluarga"){echo "selected";}?>>Keluarga</option>
										<option value="3" <?php if($item->penghuni_mayoritas == "karyawan"){echo "selected";}?>>Karyawan</option>
										<option value="4" <?php if($item->penghuni_mayoritas == "karyawati"){echo "selected";}?>>Karyawati</option>
