					...
					<div id="cpanel_wrapper">
						...
						<?php echo form_open("member_manager/do_edit_listing1/".$item->id_listing_member."/".$id_user,array("class"=>"form-horizontal","name"=>"form")); ?>
							...
							<div style="width:50%;float:left">
								<div class="control-group" id="jlantai">
								 ...
								 <div class="control-group" id="arah">
									...
									<div class="controls">
									  <div class="input-prepend">
										<span class="add-on"><img width="22px;" src="<?php echo base_url(); ?>file/img/icon_compas.png"/></span><input class="span1" id="prependedInput" name="arah" size="3" type="text" value="<?php echo $item->mata_angin; ?>" />
									  </div>
							...
							<?php foreach($paket_listing as $row): ?>
								...
								<?php foreach($listing_photo as $cover): ?>
									...
									if($dumb == $cover->id_listing_photo){
										...
										echo anchor("member_manager/edit_listing_cover/".$cover->id_listing_photo."/".$id_user,"<i class='icon icon-tag'></i>",array("class"=>"photobtn2","title"=>"Jadikan foto cover listing"));
									}
					...
					<div id="delete_confirm" class="modal hide fade" style="display:none;">
						...
						<div class="modal-footer">
							<?php echo anchor("member_manager/delete_listing_photo/".$idphoto."/".$id_user,"hapus Foto",array("class"=>"btn btn-primary")); ?>
					...
					<div id="add_photo" class="modal hide fade" style="display:none;">
						...
						<div class="modal-body">
								...
								<?php endforeach; ?>
								<?php echo form_open_multipart("member_manager/add_listing_photo/".$pk."/".$id_user); ?>
