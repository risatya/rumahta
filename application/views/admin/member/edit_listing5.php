					...
					<div id="cpanel_wrapper">
						...
						<?php echo form_open("member_manager/do_edit_listing5/".$item->id_listing_member."/".$id_user,array("class"=>"form-horizontal","name"=>"form")); ?>
						...
						<fieldset>
							...
							<div class="control-group" id="status">
								...
								<div class="controls docs-input-sizes">
									<?php $status = array("kontraktor","arsitektur","") ?>
									<select name="status"  size="1" class="span3">
										<option value="1" <?php if($item->status == "kontraktor"){echo "selected";}?>>Kontraktor</option>
										<option value="2" <?php if($item->status == "arsitektur"){echo "selected";}?>>Arsitektur</option>
										<option value="3" <?php if($item->status == "Kontraktor dan arsitektur"){echo "selected";}?>>Kontraktor dan Arsitektur</option>
										<option value="4" <?php if($item->status == "Toko bahan bangunan"){echo "selected";}?>>Toko Bahan Bangunan</option>
										<option value="5" <?php if($item->status == "Tukang / buruh bangunan"){echo "selected";}?>>Tukang / Buruh Bangunan</option>
									</select>*<i><u><?php echo form_error('status'); ?></u></i>
								</div>
							</div>
