...
class Banner{
	...
	public function getBannerPic(){
		...
		if($top1 != false){
			...
			$bannerData['top1']['pic'] = "top_default.jpg";
			$bannerData['top1']['url'] = base_url()."index.php/page/page_detail/15/pasang-iklan";
		}
		...
		if($side1 != false){
			...
			if(($expired > $now) && ($side1[0]->status == 1)){
				...
				$bannerData['side1']['pic'] = "side_default.jpg";
				$bannerData['side1']['url'] = base_url()."index.php/page/page_detail/15/pasang-iklan";
			}
		}
		else{
			$bannerData['side1']['pic'] = "side_default.jpg";
		...
		if($side2 != false){
			...
			if(($expired > $now) && ($side2[0]->status == 1)){
				...
				$bannerData['side2']['pic'] = "side_default.jpg";
				$bannerData['side2']['url'] = base_url()."index.php/page/page_detail/15/pasang-iklan";
			}
		}
		else{
			$bannerData['side2']['pic'] = "side_default.jpg";
		...
		if($side3 != false){
			...
			if(($expired > $now) && ($side3[0]->status == 1)){
				...
				$bannerData['side3']['pic'] = "side_default.jpg";
				$bannerData['side3']['url'] = base_url()."index.php/page/page_detail/15/pasang-iklan";
			}
		}
		else{
			$bannerData['side3']['pic'] = "side_default.jpg";
		...
		if($side4 != false){
			...
			if(($expired > $now) && ($side4[0]->status == 1)){
				...
				$bannerData['side4']['pic'] = "side_default.jpg";
				$bannerData['side4']['url'] = base_url()."index.php/page/page_detail/15/pasang-iklan";
			}
		}
		else{
			$bannerData['side4']['pic'] = "side_default.jpg";
		...
		if($side5 != false){
			...
			if(($expired > $now) && ($side5[0]->status == 1)){
				...
				$bannerData['side5']['pic'] = "side_default.jpg";
				$bannerData['side5']['url'] = base_url()."index.php/page/page_detail/15/pasang-iklan";
			}
		}
		else{
			$bannerData['side5']['pic'] = "side_default.jpg";
		...
		if($bottom1 != false){
			...
			if(($expired > $now) && ($bottom1[0]->status == 1)){
				...
				$bannerData['bottom1']['url'] = base_url()."index.php/page/page_detail/15/pasang-iklan";
			}
		}
		else{
			$bannerData['bottom1']['pic'] = "bottom_default.jpg";
		...
		if($bottom2 != false){
			...
			if(($expired > $now) && ($bottom2[0]->status == 1)){
				...
				$bannerData['bottom2']['url'] = base_url()."index.php/page/page_detail/15/pasang-iklan";
			}
		}
		else{
			$bannerData['bottom2']['pic'] = "bottom_default.jpg";
