	...
	<?php foreach($list_listing as $item): ?>
		...
		<li>
			<a href="<?php echo base_url(); ?>index.php/page/listing_detail/<?php echo $item->id_listing_member; ?>">
				...
				<?php } ?> 
				<h4 class="judul_listing" style="font-style:8px"><?php echo strtoupper($item->nama_kategori)."<br/>".($item->laku == 1 ? "(".($item->status_kategori == 1 ? "<b>TERJUAL</b>" : "<b>TERSEWA</b>").") " : "").$item->judul; ?></h4>
