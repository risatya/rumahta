	...
	<?php foreach($listing as $item ):?>
		...
		<div data-role="content" class="container ui-content map_content" role="main">
			...
			<div data-role="content" class="container ui-content" role="main">
					<img src="<?php echo base_url(); ?>file/img/icon_listrik.png" width="20px" style="margin-top:-5px;"/> <span class="spanstyle">DAYA LISTRIK : </span> <?php echo $item->daya_listrik; ?> M<sup>2</sup><br/>
					<img src="<?php echo base_url(); ?>file/img/icon_luas.png" width="20px" style="margin-top:-5px;"/> <span class="spanstyle">LUAS BANGUNAN : </span> <?php echo $item->luas_bangunan; ?> Watt<br/>
			</div><!-- /grid-a -->
