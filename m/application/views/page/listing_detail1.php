	...
	<?php foreach($listing as $item ):?>
		...
		<div data-role="content" class="container ui-content map_content" role="main">
			...
			<div data-role="content" class="container ui-content" role="main">
					...
					<img src="<?php echo base_url(); ?>file/img/icon_bedroom.png" width="20px" style="margin-top:-5px;"/> <span class='spanstyle'>KAMAR TIDUR : </span> <?php echo ($item->jml_ktidur == 0 || $item->jml_ktidur == null ? "-" : $item->jml_ktidur); ?> <br/>
					<img src="<?php echo base_url(); ?>file/img/icon_bathroom.png" width="20px" style="margin-top:-5px;"/> <span class='spanstyle'>KAMAR MANDI : </span> <?php echo ($item->jml_kmandi == 0 || $item->jml_kmandi == null ? "-" : $item->jml_kmandi); ?> <br/>
					<img src="<?php echo base_url(); ?>file/img/icon_pembantu.png" width="20px" style="margin-top:-5px;"/> <span class='spanstyle'>KAMAR PEMBANTU : </span> <?php echo ($item->pembantu == 0 || $item->pembantu == null ? "-" : $item->pembantu); ?> <br/>
					...
					<img src="<?php echo base_url(); ?>file/img/icon_garage.png" width="20px" style="margin-top:-5px;"/> <span class='spanstyle'>GARASI : </span> <?php echo ($item->garasi == 0 || $item->garasi == null ? "-" : $item->garasi); ?> <br/>
					<img src="<?php echo base_url(); ?>file/img/icon_home.png" width="20px" style="margin-top:-5px;"/> <span class='spanstyle'>FURNITURE : </span> <?php echo $item->furniture; ?> <br/>
					<img src="<?php echo base_url(); ?>file/img/icon_listrik.png" width="20px" style="margin-top:-5px;"/> <span class='spanstyle'>DAYA LISTRIK : </span> <?php echo $item->daya_listrik; ?> Watt <br/>
					<img src="<?php echo base_url(); ?>file/img/icon_water.png" width="20px" style="margin-top:-5px;"/> <span class='spanstyle'>SUMBER AIR : </span> <?php echo $item->sumber_air; ?> <br/>
					<img src="<?php echo base_url(); ?>file/img/icon_compas.png" width="20px" style="margin-top:-5px;"/> <span class='spanstyle'>ARAH MATA ANGIN : </span> <?php echo $item->mata_angin; ?> <br/>
			</div><!-- /grid-a -->
