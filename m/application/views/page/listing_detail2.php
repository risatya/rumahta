	...
	<?php foreach($listing as $item ):?>
		...
		<div data-role="content" class="container ui-content map_content" role="main">
			...
			<div data-role="content" class="container ui-content" role="main">
					<img src="<?php echo base_url(); ?>file/img/icon_garden.png" width="20px" style="margin-top:-5px;"/> <span class="spanstyle">LUAS TANAH : </span> <?php echo $item->luas_tanah; ?> M<sup>2</sup><br/>
